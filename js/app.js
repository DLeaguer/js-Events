...
showMenu.style.cursor = 'pointer';
function valueMenu(){
	menu.innerHTML = 'Chicken McNuggets, French Fries, Vanilla Shake';
}
...
var myQuote = "I hope you live a life you're proud of.  And if you find that you're not, I hope you have the strength to start all over again.";
...
random.addEventListener('click', showQuotes);
function showQuotes(){
...
*/
 showHide.addEventListener('click', showCat);
