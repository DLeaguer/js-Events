...
// var baconMore = document.getElementById('more');
var baconMore = document.createElement('p');
baconMore.innerHTML = bacon;
more.appendChild(baconMore);
}
